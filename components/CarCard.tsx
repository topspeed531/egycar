...
export default function CarCard({ car }: { car: Car }) {
  return (
    <article className="card overflow-hidden hover:-translate-y-1 transition-transform relative">
      <button className="absolute top-3 left-3 z-10 w-10 h-10 rounded-full bg-white/90 grid place-items-center">
        <Heart size={18} />
      </button>
      ...
      <Link href={'/cars/' + car.id} className="block">
        ...
        <div className="p-5">
          ...
          <div className="text-2xl font-black text-blue-700 mb-4">
            ...
            <span className="text-sm text-slate-500">جنيه</span>
          </div>
